...
${JAVA_HOME}/bin/java -cp ${DEPLOY_PATH}/resources:${DEPLOY_PATH}/lib/*:${DEPLOY_PATH}/lib/Fusion-Server-1.0.jar:. ${JAVA_OPTIONS} ${JAVA_DEBUG} com.fusion.manage.FusionServerApplication $prog &
