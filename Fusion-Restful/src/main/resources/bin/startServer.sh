...
export JAVA_OPTIONS="-Xmx4024m -Xms4024m -XX:MaxPermSize=4024m"
...
${JAVA_HOME}/bin/java -cp ${DEPLOY_PATH}/resources:${DEPLOY_PATH}/lib/*:${DEPLOY_PATH}/lib/Fusion-Restful-1.0.jar:. ${JAVA_OPTIONS} ${JAVA_DEBUG} com.fusion.manage.FusionRestApplication $prog &
